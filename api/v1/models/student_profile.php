...
class StudentProfile {
    ...
    function create() {
        ...
        $this->personal_details = htmlspecialchars(strip_tags($this->personal_details));
        ...
        $stmt->bindParam(":personal_details", $this->personal_details);
